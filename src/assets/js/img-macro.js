...
Macro.add("img", {
    handler() {
        ...
        if (typeof this.args[2] === 'undefined' || this.args[2] === true) {
            // TODO: If settings.noblur, don't blue images.
        ...
        if (this.args[1] === "verti-left") {
            // Horizontally position the image.
            $(this.output).wiki(`<br><imgverti style="float: left; clear: left;"><img src="${this.args[0]}" ${blurred}></imgverti>`);
        }

        if (this.args[1] === "verti-right") {
            // Horizontally position the image.
            $(this.output).wiki(`<br><imgverti style="float: right; clear: right;"><img src="${this.args[0]}" ${blurred}></imgverti>`);
        }
